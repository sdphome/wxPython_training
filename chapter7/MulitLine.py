...
class TextFrame(wx.Frame):
    def __init__(self):
        ...
        multiText = wx.TextCtrl(panel, -1, "Here is a looooooooooooooong line of text set in the control.\n\n"
                                "See that is wrapped, and that this line is after a blank", size=(200, 100), style=wx.TE_MULTILINE)
        multiText.SetInsertionPoint(0)  #设置输入位置
        ...
        richText.SetStyle(44, 52, wx.TextAttr("White", "Black"))  #设置44-52个字符显示黑底包子
        points = richText.GetFont().GetPointSize()
        f = wx.Font(points + 3, wx.ROMAN, wx.ITALIC, wx.BOLD, True) #创建一个字体
        richText.SetStyle(68, 82, wx.TextAttr("blue", wx.NullColour, f)) #用新字体显示
